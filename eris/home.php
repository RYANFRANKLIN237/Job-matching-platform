  ...
  <!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="<?php echo web_root; ?>plugins/home-plugins/img/slides/8.jpeg" alt="" />
          ...
          <p>We create the opportunities</p> 
              ...
              <li>
                <img src="<?php echo web_root; ?>plugins/home-plugins/img/slides/9.jpeg" alt="" />
                <div class="flex-caption">
                    <h3>Specialize</h3> 
    ...
    <div class="row">
      <div class="col-sm-6 col-sm-offset-6 col-xs-12 content">
        ...
        <div class="editContent"  style="height:235px;">
          <p> 
          &nbsp;&nbsp;Meet our exceptional team behind the scenes! We are a group of passionate individuals driven by one mission: to empower graduates in their job search. With diverse expertise in design, development, and innovation, we're here to revolutionize the way you find employment. Get ready to embark on an exciting journey with us!<br/><br/></p>
        </div> 
      </div>
    </div><!-- /.row-->
  </div><!-- /.container -->
