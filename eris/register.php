     ...
     <p> <?php check_message();?></p>      
		...
		<div class="row"> 
			...
			<div class="form-group">
			  <div class="col-md-8">
			    <label class="col-md-4 control-label" for=
			    "DEGREE">Speciality:</label>

			    <div class="col-md-8">
			      <input name="deptid" type="hidden" value="">
			      <input  class="form-control input-sm" id="DEGREE" name="DEGREE" placeholder=
			          "Speciality"    onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
			      </div>
			  </div>
			</div>  
			<div class="form-group">
			    <div class="col-md-8">
			      ...
			      <div class="col-md-8"> 
			      		<label><input type="checkbox"> By Signing up you are agreeing with our <a href="#">terms and condition</a></label>
			     </div>
			    </div>
			</div>    
			<div class="form-group">
