...
<head>
<meta charset="utf-8">
<title>PLANGRAD / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+237) 677 345 458</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">PLANGRAD<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Dispensaire, Messassi<br>
           Yaounde, Cameroon.</address>
          <p>
            <i class="icon-phone"></i> (237) 699 448 777 <br>
            <i class="icon-envelope-alt"></i> plangrad@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
